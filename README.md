...
💻 Foco em Backend Java e Desenvolvimento de Sistemas  

---

## 💡 O que eu entrego

- Resolução de problemas com foco prático e eficiente  
- Comunicação clara com usuários e equipes técnicas  
- Experiência real com suporte técnico em sistemas SaaS  
...
Meu objetivo é criar soluções que otimizem processos, reduzam falhas e melhorem a experiência do usuário.
...
Sistema de gerenciamento de chamados com Design Patterns (Singleton, Factory e Strategy).  
...
Script para organização de tickets, classificação por prioridade e geração de relatórios em CSV.  
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Nathalye-Belinschi-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/nathalye-belinschi)
